...
export const LOOP_ENGINE_CCO_LINE =
  "Loop Engine is the operational decision control layer behind Commerce Chain Optimization — adopt it standalone or compose it into Better Data's hosted platform.";
