---
title: AI as Actor
description: AI is one actor among several in Boss Loops - it can recommend and execute transitions within defined bounds, never outside them.
...
Boss Loops treats AI the same way it treats humans and automation: as an attributed actor constrained by transitions and guards.
