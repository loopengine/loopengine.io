---
title: Loop Library
description: The loop library provides canonical YAML definitions you can run directly or use as patterns.
...
Boss Loops currently ships these canonical definitions from `loops/`:
