...
description: Research with citations, governance in Boss Loops, execution and escalation in PagerDuty — with a tamper-evident audit trail throughout.
...
```text
                    ...
                    │
Perplexity Sonar ──►│  Boss Loops — governed-incident-response FSM
                    │
