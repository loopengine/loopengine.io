...
description: Research with citations, governance in Boss, execution and escalation in PagerDuty — with a tamper-evident audit trail throughout.
...
```text
                    ...
                    │
Perplexity Sonar ──►│  Boss — governed-incident-response FSM
                    │
