...
Boss Loops storage is an adapter boundary. This example swaps `adapter-memory` for `adapter-postgres` without changing loop definitions or transition logic.
