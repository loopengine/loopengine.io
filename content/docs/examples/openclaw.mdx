...
description: Use OpenClaw as the human approval channel for Boss and route approval gates through WhatsApp, Telegram, Slack, or Discord.
section: Examples
---
...
| --- | --- |
| **Provider** | Optional — agent reasoning may live in OpenClaw; governed transitions still pass through Boss |
...
OpenClaw handles delivery and replies across messaging channels, while Boss owns state transitions, actor constraints, and guard decisions.
