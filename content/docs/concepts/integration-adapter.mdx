...
| **Channel** | Human-surface routing on `EventBus` / approval delivery | `@loop-engine/adapter-openclaw` (Slack/Teams via [Loop Engine Cloud](/docs/integrations/loop-engine-cloud-api)) |
