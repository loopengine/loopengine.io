---
title: When to Use Boss Loops
description: Is Boss Loops right for your use case? Use this page to decide quickly.
...
Boss Loops works alongside workflow engines and agent frameworks - it does not replace them.
...
If you are asking, "can the AI just do this without approval?" that is usually the signal that you need Boss Loops.
