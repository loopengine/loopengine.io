---
title: When to Use Boss
description: Is Boss right for your use case? Use this page to decide quickly.
...
Boss works alongside workflow engines and agent frameworks - it does not replace them.
...
If you are asking, "can the AI just do this without approval?" that is usually the signal that you need Boss.
