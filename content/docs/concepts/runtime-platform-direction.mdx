...
description: Self-host operational runtime direction — what ships in OSS today, what Loop Engine Cloud adds, and roadmap-only extensions (constrained language).
...
→ [Runtime Taxonomy](/docs/concepts/runtime-taxonomy) · [Architecture](/docs/getting-started/architecture) · [Loop Engine Cloud API](/docs/integrations/loop-engine-cloud-api)
...
Need managed Slack/Google connectors + tenancy API?
    → Loop Engine Cloud (hosted Integration path)
...
- [Loop Engine vs Workflow Engines](/docs/concepts/loop-engine-vs-workflow-engines) — execution vs governance
