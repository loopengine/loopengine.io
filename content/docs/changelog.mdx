---
title: Changelog
description: All notable changes to Boss
section: Project
order: 10
---
...
All notable changes to Boss will be documented here.
...
### Documentation
- [Runtime Platform Direction](/docs/concepts/runtime-platform-direction) — self-host operational runtime narrative, OSS vs Boss Cloud, roadmap-only extensions (registry, audit store, observability collector, replay, Studio, compose) with constrained claims language
