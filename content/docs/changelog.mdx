---
title: Changelog
description: All notable changes to Boss Loops
section: Project
order: 10
---
...
All notable changes to Boss Loops will be documented here.
...
### Documentation
- [Runtime Platform Direction](/docs/concepts/runtime-platform-direction) — self-host operational runtime narrative, OSS vs Boss Loops Cloud, roadmap-only extensions (registry, audit store, observability collector, replay, Studio, compose) with constrained claims language
