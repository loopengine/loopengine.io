...
### Documentation
- [Runtime Platform Direction](/docs/concepts/runtime-platform-direction) — self-host operational runtime narrative, OSS vs Loop Engine Cloud, roadmap-only extensions (registry, audit store, observability collector, replay, Studio, compose) with constrained claims language
