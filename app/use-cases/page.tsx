    ...
    <main className="px-4 py-12">
      ...
      <section className="mx-auto mt-10 max-w-6xl">
        ...
        >
          ...
          <h2 className="mt-2 font-[var(--font-display)] text-[var(--color-ink)] text-2xl">
            <Link href="/use-cases/enterprise-it" className="hover:underline">
              From AI productivity tool to governed enterprise actor
            </Link>
          </h2>
          <p className="mt-2 text-sm text-[var(--color-ink-tertiary)]">
            Long-form explainer: the governance wall, governed execution, PO review, metrics for IT leaders, and where to start.
          </p>
          <h3 className="mt-6 font-[var(--font-display)] text-[var(--color-ink)] text-xl">Governed AI for regulated industries</h3>
